...
const CreateRoute = {
  ...
  validateRoutePath(argv) {
    if (argv.length !== 4) {
      ...
      this.log.error("Please enter route path and name");
      this.end();
      ...
      [, , this.ROUTE_PATH, this.ROUTE_NAME] = argv;
